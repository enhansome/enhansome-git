...
* [Flight rules for Git](https://github.com/k88hudson/git-flight-rules) ⭐ 42,596 | 🐛 14 | 📅 2026-07-23 - guide about what to do when things go wrong
* [Git Tips](https://github.com/git-tips/tips) ⭐ 21,721 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-10
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,441 | 🐛 2 | 📅 2026-03-04
* [Git-It](https://github.com/jlord/git-it-electron) ⭐ 4,891 | 🐛 139 | 🌐 Perl | 📅 2024-04-10 - Interactive Tutorial App that runs on your Desktop!
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,034 | 🐛 1,026 | 🌐 Go | 📅 2026-09-05 - A simple terminal UI for git commands, written in Go
* [Ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,600 | 🐛 237 | 🌐 JavaScript | 📅 2026-09-03 - The easiest way to use git. On any platform. Anywhere.
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,398 | 🐛 43 | 🌐 Java | 📅 2026-09-04 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,272 | 🐛 387 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
* [Git Add-ons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,196 | 🐛 18 | 📅 2024-10-15 - Enhance the basic `git` CLI
* [SGit](https://github.com/sheimi/SGit) ⭐ 379 | 🐛 6 | 🌐 Java | 📅 2021-11-18 - Git client for Android 4.x
* [gitj (Git Journey)](https://github.com/roblillack/gitj) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - Fast, small, cross-platform GUI git client (gitk/git-gui style) with image diff support
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 972 | 🐛 12 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,894 | 🐛 48 | 📅 2024-04-15
    * [GitHub Browser Extensions](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,296 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,228 | 🐛 0 | 🌐 Java | 📅 2026-09-03 - Self-hosted Git Server with Kanban and CI/CD
* [GitBucket](https://github.com/takezoe/gitbucket/) ⭐ 9,403 | 🐛 332 | 🌐 Scala | 📅 2026-09-05 - a GitHub clone powered by Scala.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,213 | 🐛 80 | 🌐 Go | 📅 2026-09-01 - a tasty, self-hostable Git server for the command line
...
* [husky](https://github.com/typicode/husky) ⭐ 35,307 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,776 | 🐛 103 | 🌐 Go | 📅 2026-08-31 - fast and powerful Git hooks manager for any type of project.
* [Overcommit](https://github.com/brigade/overcommit) ⭐ 4,007 | 🐛 34 | 🌐 Ruby | 📅 2026-08-31 - a extendable Git hook manager written with Ruby.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,613 | 🐛 74 | 📅 2026-09-04 - collection of gitignore files for various programming language
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,103 | 🐛 96 | 🌐 Shell | 📅 2026-09-01 – git utilities adding useful git commands.
* [tig](https://github.com/jonas/tig) ⭐ 13,323 | 🐛 232 | 🌐 C | 📅 2026-07-27 - text-mode interface for git.
* [release-it](https://github.com/webpro/release-it) ⭐ 9,043 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or npm packages. Changelog generation, GitHub/GitLab releases, etc.
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,507 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-05 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
* [bash-git-prompt](https://github.com/magicmonty/bash-git-prompt) ⭐ 6,939 | 🐛 35 | 🌐 Shell | 📅 2026-04-10 - An informative and fancy bash prompt for Git users
...
* [git-absorb](https://github.com/tummychow/git-absorb) ⭐ 5,715 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - `git commit --fixup`, but automatic
* [ghq](https://github.com/motemen/ghq) ⭐ 3,764 | 🐛 44 | 🌐 Go | 📅 2026-08-24 — Organization for remote repositories
* [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,196 | 🐛 18 | 📅 2024-10-15 - lists more than 20 git addons including all available commands
* [gickup](https://github.com/cooperspencer/gickup) ⭐ 1,461 | 🐛 52 | 🌐 Go | 📅 2026-09-01 - Backup repos from various hosters to local or other hosters.
* [multi-gitter](https://github.com/lindell/multi-gitter) ⭐ 1,232 | 🐛 58 | 🌐 Go | 📅 2026-09-03 - a tool to make changes in multiple repositories simultaneously
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,170 | 🐛 2 | 🌐 Shell | 📅 2026-09-04 - Another collection of useful git commands.
* [gitbackup](https://github.com/amitsaha/gitbackup) ⭐ 236 | 🐛 11 | 🌐 Go | 📅 2026-07-11 - a tool to backup your Bitbucket, GitHub and GitLab repositories.
* [soba](https://github.com/jonhadfield/soba) ⭐ 172 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - scheduled backups of repositories from popular providers with change detection.
...
* [Git Virtual File System or GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,135 | 🐛 318 | 🌐 C# | 📅 2026-09-04 - solution for managing very large Git repository while maintaining speed and efficiency of most operations. in developement by Microsoft.
