...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,115 | 🐛 1,030 | 🌐 Go | 📅 2026-09-07 - A simple terminal UI for git commands, written in Go
* [Ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,601 | 🐛 238 | 🌐 JavaScript | 📅 2026-09-03 - The easiest way to use git. On any platform. Anywhere.
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,429 | 🐛 43 | 🌐 Java | 📅 2026-09-07 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,273 | 🐛 387 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 972 | 🐛 13 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,923 | 🐛 48 | 📅 2024-04-15
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,230 | 🐛 0 | 🌐 Java | 📅 2026-09-07 - Self-hosted Git Server with Kanban and CI/CD
...
* [husky](https://github.com/typicode/husky) ⭐ 35,309 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,786 | 🐛 98 | 🌐 Go | 📅 2026-09-07 - fast and powerful Git hooks manager for any type of project.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,652 | 🐛 75 | 📅 2026-09-04 - collection of gitignore files for various programming language
...
* [release-it](https://github.com/webpro/release-it) ⭐ 9,048 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or npm packages. Changelog generation, GitHub/GitLab releases, etc.
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,506 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-07 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,170 | 🐛 2 | 🌐 Shell | 📅 2026-09-07 - Another collection of useful git commands.
