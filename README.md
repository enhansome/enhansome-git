...
* [Git Tips](https://github.com/git-tips/tips) ⭐ 21,725 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-10
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,630 | 🐛 1,025 | 🌐 Go | 📅 2026-08-25 - A simple terminal UI for git commands, written in Go
...
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,285 | 🐛 40 | 🌐 Java | 📅 2026-08-24 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,262 | 🐛 386 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
...
* [gitj (Git Journey)](https://github.com/roblillack/gitj) ⭐ 2 | 🐛 1 | 🌐 Rust | 📅 2026-08-25 - Fast, small, cross-platform GUI git client (gitk/git-gui style) with image diff support
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 970 | 🐛 12 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,714 | 🐛 48 | 📅 2024-04-15
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,178 | 🐛 0 | 🌐 Java | 📅 2026-08-25 - Self-hosted Git Server with Kanban and CI/CD
...
* [husky](https://github.com/typicode/husky) ⭐ 35,284 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,727 | 🐛 91 | 🌐 Go | 📅 2026-08-25 - fast and powerful Git hooks manager for any type of project.
...
* [quickhook](https://github.com/dirk/quickhook) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2026-08-25 - a fast, Unix'y, opinionated Git hook runner.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,461 | 🐛 82 | 📅 2026-08-25 - collection of gitignore files for various programming language
...
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,501 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-25 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [Git Virtual File System or GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,133 | 🐛 320 | 🌐 C# | 📅 2026-08-20 - solution for managing very large Git repository while maintaining speed and efficiency of most operations. in developement by Microsoft.
