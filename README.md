...
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,440 | 🐛 2 | 📅 2026-03-04
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,872 | 🐛 1,027 | 🌐 Go | 📅 2026-09-02 - A simple terminal UI for git commands, written in Go
...
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,349 | 🐛 43 | 🌐 Java | 📅 2026-08-24 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,268 | 🐛 385 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
* [Git Add-ons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,196 | 🐛 16 | 📅 2024-10-15 - Enhance the basic `git` CLI
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 972 | 🐛 12 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,826 | 🐛 48 | 📅 2024-04-15
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,206 | 🐛 0 | 🌐 Java | 📅 2026-09-01 - Self-hosted Git Server with Kanban and CI/CD
* [GitBucket](https://github.com/takezoe/gitbucket/) ⭐ 9,401 | 🐛 332 | 🌐 Scala | 📅 2026-08-31 - a GitHub clone powered by Scala.
...
* [husky](https://github.com/typicode/husky) ⭐ 35,301 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,757 | 🐛 101 | 🌐 Go | 📅 2026-08-31 - fast and powerful Git hooks manager for any type of project.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,536 | 🐛 84 | 📅 2026-09-01 - collection of gitignore files for various programming language
...
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,504 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-01 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [git-absorb](https://github.com/tummychow/git-absorb) ⭐ 5,711 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - `git commit --fixup`, but automatic
* [ghq](https://github.com/motemen/ghq) ⭐ 3,763 | 🐛 43 | 🌐 Go | 📅 2026-08-24 — Organization for remote repositories
* [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,196 | 🐛 16 | 📅 2024-10-15 - lists more than 20 git addons including all available commands
* [gickup](https://github.com/cooperspencer/gickup) ⭐ 1,457 | 🐛 48 | 🌐 Go | 📅 2026-09-01 - Backup repos from various hosters to local or other hosters.
* [multi-gitter](https://github.com/lindell/multi-gitter) ⭐ 1,232 | 🐛 58 | 🌐 Go | 📅 2026-09-01 - a tool to make changes in multiple repositories simultaneously
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,168 | 🐛 7 | 🌐 Shell | 📅 2026-08-31 - Another collection of useful git commands.
...
* [soba](https://github.com/jonhadfield/soba) ⭐ 172 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - scheduled backups of repositories from popular providers with change detection.
