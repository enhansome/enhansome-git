...
* [Flight rules for Git](https://github.com/k88hudson/git-flight-rules) ⭐ 42,593 | 🐛 14 | 📅 2026-07-23 - guide about what to do when things go wrong
* [Git Tips](https://github.com/git-tips/tips) ⭐ 21,722 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-10
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,447 | 🐛 2 | 📅 2026-03-04
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,248 | 🐛 1,035 | 🌐 Go | 📅 2026-09-11 - A simple terminal UI for git commands, written in Go
* [Ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,600 | 🐛 238 | 🌐 JavaScript | 📅 2026-09-03 - The easiest way to use git. On any platform. Anywhere.
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,550 | 🐛 44 | 🌐 Java | 📅 2026-09-11 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,273 | 🐛 373 | 🌐 C++ | 📅 2026-09-11 - a graphical Git client designed to help you understand and manage your source code history.
* [Git Add-ons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 19 | 📅 2024-10-15 - Enhance the basic `git` CLI
* [SGit](https://github.com/sheimi/SGit) ⭐ 378 | 🐛 6 | 🌐 Java | 📅 2021-11-18 - Git client for Android 4.x
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 971 | 🐛 13 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,995 | 🐛 48 | 📅 2024-04-15
    * [GitHub Browser Extensions](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,300 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,237 | 🐛 0 | 🌐 Java | 📅 2026-09-12 - Self-hosted Git Server with Kanban and CI/CD
* [GitBucket](https://github.com/takezoe/gitbucket/) ⭐ 9,402 | 🐛 332 | 🌐 Scala | 📅 2026-09-08 - a GitHub clone powered by Scala.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,217 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - a tasty, self-hostable Git server for the command line
...
* [husky](https://github.com/typicode/husky) ⭐ 35,310 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,803 | 🐛 99 | 🌐 Go | 📅 2026-09-07 - fast and powerful Git hooks manager for any type of project.
* [Overcommit](https://github.com/brigade/overcommit) ⭐ 4,006 | 🐛 34 | 🌐 Ruby | 📅 2026-09-06 - a extendable Git hook manager written with Ruby.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,720 | 🐛 73 | 📅 2026-09-11 - collection of gitignore files for various programming language
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,103 | 🐛 97 | 🌐 Shell | 📅 2026-09-01 – git utilities adding useful git commands.
* [tig](https://github.com/jonas/tig) ⭐ 13,330 | 🐛 233 | 🌐 C | 📅 2026-07-27 - text-mode interface for git.
...
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,508 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-11 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [git-absorb](https://github.com/tummychow/git-absorb) ⭐ 5,717 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - `git commit --fixup`, but automatic
* [ghq](https://github.com/motemen/ghq) ⭐ 3,767 | 🐛 44 | 🌐 Go | 📅 2026-08-24 — Organization for remote repositories
* [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 19 | 📅 2024-10-15 - lists more than 20 git addons including all available commands
* [gickup](https://github.com/cooperspencer/gickup) ⭐ 1,463 | 🐛 47 | 🌐 Go | 📅 2026-09-11 - Backup repos from various hosters to local or other hosters.
* [multi-gitter](https://github.com/lindell/multi-gitter) ⭐ 1,232 | 🐛 58 | 🌐 Go | 📅 2026-09-06 - a tool to make changes in multiple repositories simultaneously
...
* [gitbackup](https://github.com/amitsaha/gitbackup) ⭐ 237 | 🐛 11 | 🌐 Go | 📅 2026-07-11 - a tool to backup your Bitbucket, GitHub and GitLab repositories.
* [soba](https://github.com/jonhadfield/soba) ⭐ 171 | 🐛 3 | 🌐 Go | 📅 2026-09-11 - scheduled backups of repositories from popular providers with change detection.
