...
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,426 | 🐛 2 | 📅 2026-03-04
...
* [The ultimate guide to <code>.gitignore</code>](https://github.com/groda/the_ultimate_gitignore_guide) ⭐ 41 | 🐛 2 | 📅 2026-04-10 All about `.gitignore`.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,380 | 🐛 1,019 | 🌐 Go | 📅 2026-08-16 - A simple terminal UI for git commands, written in Go
* [Ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,597 | 🐛 232 | 🌐 JavaScript | 📅 2026-08-05 - The easiest way to use git. On any platform. Anywhere.
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,121 | 🐛 41 | 🌐 Java | 📅 2026-08-16 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,256 | 🐛 383 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 970 | 🐛 14 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,543 | 🐛 48 | 📅 2024-04-15
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,160 | 🐛 0 | 🌐 Java | 📅 2026-08-16 - Self-hosted Git Server with Kanban and CI/CD
* [GitBucket](https://github.com/takezoe/gitbucket/) ⭐ 9,389 | 🐛 330 | 🌐 Scala | 📅 2026-08-14 - a GitHub clone powered by Scala.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,163 | 🐛 79 | 🌐 Go | 📅 2026-08-12 - a tasty, self-hostable Git server for the command line
...
* [husky](https://github.com/typicode/husky) ⭐ 35,275 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - modern native Git hooks made easy.
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,653 | 🐛 90 | 🌐 Go | 📅 2026-08-03 - fast and powerful Git hooks manager for any type of project.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,331 | 🐛 83 | 📅 2026-07-23 - collection of gitignore files for various programming language
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,095 | 🐛 98 | 🌐 Shell | 📅 2026-08-14 – git utilities adding useful git commands.
* [tig](https://github.com/jonas/tig) ⭐ 13,305 | 🐛 225 | 🌐 C | 📅 2026-07-27 - text-mode interface for git.
...
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,498 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-15 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [ghq](https://github.com/motemen/ghq) ⭐ 3,739 | 🐛 41 | 🌐 Go | 📅 2026-08-10 — Organization for remote repositories
...
* [gickup](https://github.com/cooperspencer/gickup) ⭐ 1,439 | 🐛 48 | 🌐 Go | 📅 2026-08-10 - Backup repos from various hosters to local or other hosters.
* [multi-gitter](https://github.com/lindell/multi-gitter) ⭐ 1,228 | 🐛 55 | 🌐 Go | 📅 2026-08-11 - a tool to make changes in multiple repositories simultaneously
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,171 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Another collection of useful git commands.
* [gitbackup](https://github.com/amitsaha/gitbackup) ⭐ 233 | 🐛 11 | 🌐 Go | 📅 2026-07-11 - a tool to backup your Bitbucket, GitHub and GitLab repositories.
* [soba](https://github.com/jonhadfield/soba) ⭐ 170 | 🐛 6 | 🌐 Go | 📅 2026-08-03 - scheduled backups of repositories from popular providers with change detection.
...
* [Git Virtual File System or GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,124 | 🐛 322 | 🌐 C# | 📅 2026-08-14 - solution for managing very large Git repository while maintaining speed and efficiency of most operations. in developement by Microsoft.
