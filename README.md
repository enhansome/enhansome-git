...
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,448 | 🐛 2 | 📅 2026-03-04
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,282 | 🐛 1,036 | 🌐 Go | 📅 2026-09-11 - A simple terminal UI for git commands, written in Go
...
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,559 | 🐛 44 | 🌐 Java | 📅 2026-09-11 - A git client based on the IntelliJ platform
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 971 | 🐛 14 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,015 | 🐛 48 | 📅 2024-04-15
    * [GitHub Browser Extensions](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,301 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18
...
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,216 | 🐛 82 | 🌐 Go | 📅 2026-09-01 - a tasty, self-hostable Git server for the command line
...
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,808 | 🐛 99 | 🌐 Go | 📅 2026-09-07 - fast and powerful Git hooks manager for any type of project.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,743 | 🐛 73 | 📅 2026-09-11 - collection of gitignore files for various programming language
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,104 | 🐛 97 | 🌐 Shell | 📅 2026-09-01 – git utilities adding useful git commands.
* [tig](https://github.com/jonas/tig) ⭐ 13,331 | 🐛 234 | 🌐 C | 📅 2026-07-27 - text-mode interface for git.
...
* [conventional-changelog](https://github.com/conventional-changelog/conventional-changelog) ⭐ 8,508 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-12 - a set of tools for parsing [conventional commit](https://conventionalcommits.org/) messages from git histories
...
* [git-absorb](https://github.com/tummychow/git-absorb) ⭐ 5,719 | 🐛 28 | 🌐 Rust | 📅 2026-02-14 - `git commit --fixup`, but automatic
...
* [gickup](https://github.com/cooperspencer/gickup) ⭐ 1,463 | 🐛 48 | 🌐 Go | 📅 2026-09-12 - Backup repos from various hosters to local or other hosters.
