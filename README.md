...
* [Flight rules for Git](https://github.com/k88hudson/git-flight-rules) ⭐ 42,595 | 🐛 14 | 📅 2026-07-23 - guide about what to do when things go wrong
* [Git Tips](https://github.com/git-tips/tips) ⭐ 21,720 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-10
* [Git & Git-Flow Cheat Sheet](https://github.com/arslanbilal/git-cheat-sheet) ⭐ 7,442 | 🐛 2 | 📅 2026-03-04
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,077 | 🐛 1,029 | 🌐 Go | 📅 2026-09-06 - A simple terminal UI for git commands, written in Go
...
* [Rebased](https://github.com/DetachHead/rebased) ⭐ 5,405 | 🐛 45 | 🌐 Java | 📅 2026-09-06 - A git client based on the IntelliJ platform
* [Gittyup](https://github.com/Murmele/Gittyup) ⭐ 2,271 | 🐛 387 | 🌐 C++ | 📅 2026-07-21 - a graphical Git client designed to help you understand and manage your source code history.
* [Git Add-ons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 18 | 📅 2024-10-15 - Enhance the basic `git` CLI
...
* [GitHub](https://github.com/) - the de-facto git hosting service. Perfect integration with most external services.
  * [Awesome GitHub](https://github.com/phillipadsmith/awesome-github) ⭐ 972 | 🐛 13 | 📅 2024-03-04 - Resources & Learning for GitHub
    * [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,911 | 🐛 48 | 📅 2024-04-15
    * [GitHub Browser Extensions](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,298 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18
...
* [onedev](https://github.com/theonedev/onedev) ⭐ 15,230 | 🐛 0 | 🌐 Java | 📅 2026-09-06 - Self-hosted Git Server with Kanban and CI/CD
* [GitBucket](https://github.com/takezoe/gitbucket/) ⭐ 9,403 | 🐛 332 | 🌐 Scala | 📅 2026-09-05 - a GitHub clone powered by Scala.
* [Soft Serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,214 | 🐛 80 | 🌐 Go | 📅 2026-09-01 - a tasty, self-hostable Git server for the command line
...
* [lefthook](https://github.com/evilmartians/lefthook) ⭐ 8,779 | 🐛 103 | 🌐 Go | 📅 2026-08-31 - fast and powerful Git hooks manager for any type of project.
* [Overcommit](https://github.com/brigade/overcommit) ⭐ 4,007 | 🐛 33 | 🌐 Ruby | 📅 2026-09-06 - a extendable Git hook manager written with Ruby.
...
* [GitIgnore Collection](https://github.com/github/gitignore) ⭐ 175,638 | 🐛 75 | 📅 2026-09-04 - collection of gitignore files for various programming language
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,102 | 🐛 95 | 🌐 Shell | 📅 2026-09-01 – git utilities adding useful git commands.
* [tig](https://github.com/jonas/tig) ⭐ 13,326 | 🐛 232 | 🌐 C | 📅 2026-07-27 - text-mode interface for git.
* [release-it](https://github.com/webpro/release-it) ⭐ 9,045 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-09 - Automate releases for Git repositories and/or npm packages. Changelog generation, GitHub/GitLab releases, etc.
...
* [ghq](https://github.com/motemen/ghq) ⭐ 3,765 | 🐛 44 | 🌐 Go | 📅 2026-08-24 — Organization for remote repositories
* [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) ⭐ 2,197 | 🐛 18 | 📅 2024-10-15 - lists more than 20 git addons including all available commands
...
* [multi-gitter](https://github.com/lindell/multi-gitter) ⭐ 1,232 | 🐛 57 | 🌐 Go | 📅 2026-09-06 - a tool to make changes in multiple repositories simultaneously
...
* [soba](https://github.com/jonhadfield/soba) ⭐ 171 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - scheduled backups of repositories from popular providers with change detection.
...
* [Git Virtual File System or GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,136 | 🐛 318 | 🌐 C# | 📅 2026-09-04 - solution for managing very large Git repository while maintaining speed and efficiency of most operations. in developement by Microsoft.
